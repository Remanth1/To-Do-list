...
- **Filtering**: Filter tasks by status (All, Mine, etc.)
...
2. **Add Tasks**: Use the task input to create new to-do items.
3. **View Tasks**: Switch between different views (Dashboard, Calendar, Mine).
